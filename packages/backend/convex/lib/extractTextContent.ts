...
const SYSTEM_PROMPT = {
    ...
    pdf: `You are a helpful assistant that can extract text content from PDFs.`,
    html: `You are a helpful assistant that can extract text content from HTML.`,
}
            ...
            messages: [
                {
                    ...
                    content: [
                        { type: "text", text },
                        { type: "text", text: "Extract the text content and print it in a markdown format without explaining you'll do so" },
                    ],
                },
            ],
        })
        ...
        messages: [
            {
                ...
                content: [
                    ...
                    { type: "text", text: "Extract text content from this PDF and print it without explaining you'll do so" },
                ],
            },
        ],
    });
